...
class XenManager:
    ...
    def transfer_money(self, amount, from_wallet, csv_path):
        ...
        for to_wallet in to_wallets:
            ...
            print(f'Transferring {amount} from {from_wallet[Addr_Index]} to {to_wallet[Addr_Index]}, Chain:{self._chain_id}, Nonce:{params["nonce"]}, {params["gas"]}, {params["gasPrice"]}')
    ...
    def update_transfer_gas(self, from_addr, to_addr, trans_params):
        estimate_gas = self._web3.eth.estimateGas({'to': from_addr, 'from': to_addr, 'value': 1})
